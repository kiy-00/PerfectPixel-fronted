    ...
    <div class="container mx-auto px-4 mt-8">
      <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div class="mb-8">
            <h3 class="font-semibold text-neutral-dark mb-3">修图师基本信息</h3>
            <div class="border border-neutral rounded-md divide-y divide-neutral">
              <div class="flex p-4">
                <div class="w-1/3 text-neutral-dark font-medium">修图经验</div>
                <div class="w-2/3 text-neutral-dark">
                  {{ getExperienceText(retoucherInfo.experience) }}
                </div>
              </div>
              <div class="flex p-4">
                <div class="w-1/3 text-neutral-dark font-medium">修图技术</div>
                <div class="w-2/3 text-neutral-dark">{{ retoucherInfo.techniques }}</div>
              </div>
              <div class="flex p-4">
                <div class="w-1/3 text-neutral-dark font-medium">所在城市</div>
                <div class="w-2/3 text-neutral-dark">{{ retoucherInfo.city }}</div>
              </div>
              <div class="flex p-4">
                <div class="w-1/3 text-neutral-dark font-medium">擅长领域</div>
                <div class="w-2/3 text-neutral-dark">
                  <span
                    v-for="(specialty, index) in getSpecialtyLabels(retoucherInfo.specialties)"
                    :key="index"
              ...
              <div class="flex p-4">
                ...
                <div class="w-2/3 text-neutral-dark">{{ retoucherInfo.bio }}</div>
              </div>
            </div>
          </div>
          ...
          <div class="mb-8">
            ...
            <div class="border border-neutral rounded-md divide-y divide-neutral">
              ...
              <div
                v-for="(link, index) in portfolioInfo.otherLinks"
                :key="index"
                class="flex p-4"
                v-show="link.trim()"
              >
                <div class="w-1/3 text-neutral-dark font-medium">其他链接 {{ index + 1 }}</div>
                <div class="w-2/3 text-neutral-dark">
          ...
          <div class="flex justify-between">
            <router-link
              to="/retoucher-certification/portfolio-links"
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <ul class="list-disc list-inside space-y-2 text-neutral-dark">
            ...
            <li>审核通过后，您的修图师主页将自动生成，您可以立即接单</li>
...
export default defineComponent({
  name: 'RetoucherVerificationView',
  setup() {
    ...
    const getSpecialtyLabels = (specialties: string[]) => {
      const specialtyMap: Record<string, string> = {
        portraitRetouch: '人像精修',
        commercialRetouch: '商业精修',
        landscapeRetouch: '风景精修',
        fashionRetouch: '时尚精修',
        productRetouch: '产品精修',
        weddingRetouch: '婚礼精修',
        foodRetouch: '美食精修',
        architectureRetouch: '建筑精修',
        skinRetouch: '皮肤修饰',
      }
    ...
    const submitApplication = async () => {
      ...
      try {
        ...
        router.push('/profile?retoucherCertificationSubmitted=1')
      } catch (error: any) {
